import DocumentModal, { WorkspaceFavFoldersModal as Modal, IWorkspaceFavFoldersModal as IModal } from './workspaceFavFolders';
...
export class Repository {
  ...
  public static async findOne(body: IModal): Promise<DocumentModal> {
    return Modal
      .findOne({ ...body })
      .select("-isDeleted -updatedAt")
      .lean<DocumentModal>()
