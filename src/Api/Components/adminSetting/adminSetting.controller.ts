...
import AdminSettingRepo from "./adminSetting.repository";

export class AdminSettingController {

  getAll = asyncHandler(
    async (req: any, res: Response, next: NextFunction): Promise<Response | void> => {
      const settingDatas = await AdminSettingRepo.find();
  ...
  add = asyncHandler(
    async (req: any, res: Response, next: NextFunction): Promise<Response | void> => {
      const { settingData } = await AdminSettingRepo.create(req.body);
  ...
  delete = asyncHandler(
    async (req: any, res: Response, next: NextFunction): Promise<Response | void> => {
      const { settingData } = await AdminSettingRepo.delete(req.params._id);
  ...
  update = asyncHandler(
    async (req: any, res: Response, next: NextFunction): Promise<Response | void> => {
      const { settingData } = await AdminSettingRepo.updateCate(req.params._id, req.body)
