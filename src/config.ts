...
//   partnerId: process.env.AGC_PARTNER_ID,
//   accessKey: process.env.AGC_ACCESS_KEY,
//   secretKey: process.env.AGC_SECRET_KEY,
//   environment: process.env.AGC_ENVIRONMENT,
//   endpoint: process.env.AGC_ENDPOINT
// }
