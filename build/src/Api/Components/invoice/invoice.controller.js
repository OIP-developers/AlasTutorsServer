    ...
    constructor() {
        ...
        this.confirmPaymentIntent = (0, async_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (payment.status === 'succeeded' || true) {
                ...
                if (createdInvoice.price)
                    wallet_repository_1.WalletRepo.update(createdInvoice.userId, createdInvoice.price);
            }
            else {
                throw new ApiError_1.BadRequestError('Invoice not paid yet!');
            }
            new ApiResponse_1.SuccessResponse('payment intent successful', {
                invoice,
            }).send(res);
        }));
