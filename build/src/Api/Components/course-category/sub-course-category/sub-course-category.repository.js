...
const Sub_Course_Category_1 = require("./Sub-Course-Category");
class SubCourseCategoryRepo {
    ...
    //   });
    // }
    static create({ SubCourseCategory }) {
        return __awaiter(this, void 0, void 0, function* () {
            return Sub_Course_Category_1.CourseSubCategoryModel.create({
                data: SubCourseCategory
            });
        });
    }
    static find() {
        return Sub_Course_Category_1.CourseSubCategoryModel.findMany({});
    }
    ...
    static update({ id, category }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Sub_Course_Category_1.CourseSubCategoryModel.update({
                where: { id },
                data: category
            });
        });
    ...
    static delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return Sub_Course_Category_1.CourseSubCategoryModel.delete({
                where: { id }
            });
        });
    }
}
exports.default = SubCourseCategoryRepo;
//# sourceMappingURL=sub-course-category.repository.js.map