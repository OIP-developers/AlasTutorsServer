...
const createTokens = (user, accessTokenKey, refreshTokenKey) => __awaiter(void 0, void 0, void 0, function* () {
    const accessToken = yield JWT_1.default.encode(new JWT_1.JwtPayload(config_1.tokenInfo.issuer, config_1.tokenInfo.audience, user.id.toString(), accessTokenKey, config_1.tokenInfo.accessTokenValidityDays));
    if (!accessToken)
        throw new ApiError_1.InternalError();
    const refreshToken = yield JWT_1.default.encode(new JWT_1.JwtPayload(config_1.tokenInfo.issuer, config_1.tokenInfo.audience, user.id.toString(), refreshTokenKey, config_1.tokenInfo.refreshTokenValidityDays));
    if (!refreshToken)
        throw new ApiError_1.InternalError();
    return {
